...
- **[MONGODB_GUIDE.md](MONGODB_GUIDE.md)** - Полное руководство по работе с MongoDB (подключение, CRUD, запросы, агрегация, лучшие практики)
...
- **MongoDB Native Driver** - прямая работа с MongoDB без ORM/ODM
